...
def getData(url):
    ...
    datas = soup.findAll('a',href=True, attrs={'class':'color-charcoal small-down-text-2 text-3', 'data-track-click': 'listing_click'}, text=True)
...
n = 1
while True:
    data = list(getData(f'https://www.classcentral.com/subject/data-science?page={f}'))
    f=f+1
    if data == []:
        break
    for x in data:
